        ...
        <div style={styles.sideColumn}>
          <div style={styles.brandWrapper}>
            <h1 style={styles.brandTitle}>
              Edu<span style={styles.brandHighlight}>Forge</span>
            </h1>
            <p style={styles.brandSubtitle}>
              Unlock your potential through expert-led courses.
            </p>
          </div>
        </div>
        ...
        <div style={styles.sideColumn}>
          <div style={styles.promoWrapper}>
            <p style={styles.quoteText}>
              "Knowledge is the key to Forge your future."
            </p>
...
const styles: { [key: string]: React.CSSProperties } = {
  ...
  glowBgLeft: {
    ...
    height: '80vh',
    background:
      'radial-gradient(circle at center, rgba(246, 173, 85, 0.12) 0%, rgba(12, 17, 30, 0) 70%)',
    top: '10%',
    left: '-10%',
    zIndex: 1,
  },
  glowBgRight: {
    ...
    height: '80vh',
    background:
      'radial-gradient(circle at center, rgba(246, 173, 85, 0.08) 0%, rgba(12, 17, 30, 0) 70%)',
    bottom: '10%',
    right: '-10%',
    zIndex: 1,
  },
